...
public class FrmPessoa extends javax.swing.JFrame {
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (this.txtCodigo.getText().equals("")) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                pessoaDao.excluir(Integer.parseInt(txtCodigo.getText()));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (txtTexto.getText().equals("")) {
            ...
            pessoa.setNome(txtTexto.getText().toUpperCase());
            pessoa.setIdade(12);
            ...
            if (novo) {
                ...
                JOptionPane.showMessageDialog(this, "Alteracao com Sucesso !!!", null, JOptionPane.ERROR_MESSAGE);
            }
    ...
    public final void carregaGrelha() {
        ...
        List<Pessoa> lista = pessoaDao.getListagem();
